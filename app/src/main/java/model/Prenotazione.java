...
public class Prenotazione {
    ...
    private Taxi taxi;
    @Expose private String  serviziSpeciali[], progressivo, posizioneCliente, destinazione;
    @Expose private Date data;
    @Expose private boolean assegnata;
    @Expose private Cliente cliente;
    private double tempoAttesa;


    public Prenotazione(String progressivo, int taxi, String destinazione, String[] serviziSpeciali,
                        String posizioneCliente, Date data, boolean assegnata) {
       this.taxi = new Taxi(taxi);
    ...
    public Prenotazione(String progressivo, Taxi taxi, String destinazione, String[] serviziSpeciali,
                        String posizioneCliente, Date data, boolean assegnata) {
        this.taxi = taxi;
        this.serviziSpeciali = serviziSpeciali;
        this.destinazione = destinazione;
    ...
    public Prenotazione(String progressivo, Cliente cliente, String destinazione, String[] serviziSpeciali,
                        String posizioneCliente, Date data, boolean assegnata) {
